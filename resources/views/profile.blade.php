                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <img id="preview_img" src="" class="previewImage" width="200" height="150"/>
    ...
    <main>
        <div class="container">
            <button type="button" data-toggle="modal" data-target="#exampleModalCenter" 
                class="btn btn-status">{{ trans('profile.do_you_thing') }} {{ Auth::user()->fullname }}</button>
            @error('caption')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
            @error('imageFile')
            ...
            <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document"> 
                    <div class="modal-content">
                        <div class="modal-header">
                            <h2 class="modal-title" id="exampleModalLongTitle">{{ trans('profile.do_you_thing') }} {{ Auth::user()->fullname }}</h2>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
