...
{
    protected $profileMock, $postMock, $followMock, $timelineController;
    ...
    public function setUp() : void
    {
        ...
        $this->timelineController = new TimeLineController($this->profileMock, $this->postMock, $this->followMock);
    }
