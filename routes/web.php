...
Route::group(['middleware' => 'locale'], function () {
    ...
    Route::post('/create-story', 'ProfileController@createStory')->name('create.story');
    Route::get('/activity/user', 'ProfileController@activityHistory')->name('activity.history');
});
